...
int main() {
   const int nx = 200;
    ...
    const auto file_path = std::filesystem::current_path() / "../CPP/rt-in-one-weekend/artifacts/chapter-8.ppm";
    ...
    RT::Material *metal_2 = new RT::Metal({0.8, 0.8, 0.8}, 1.0);
    RT::Hitable *list[4];
    ...
    list[3] = new RT::Sphere(RT::Vec3(-1, 0, -1), 0.5, metal_2);
